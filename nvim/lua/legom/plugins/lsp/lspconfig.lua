        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            group = vim.api.nvim_create_augroup("UserLspConfig", {}),
              callback = function(ev)
                ...
                km.set("n", "<c-r>", "<cmd>Telescope lsp_references<CR>", opts) -- show definition, references

                opts.desc = "Go to declaration"
                km.set("n", "<c-D>", vim.lsp.buf.declaration, opts) -- go to declaration
                --
                opts.desc = "Show LSP definitions"
                km.set("n", "<c-d>", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
                --
                opts.desc = "Show LSP implementations"
                km.set("n", "<c-i>", "<cmd>Telescope lsp_implementations<CR>", opts) -- show lsp implementations
                --
