...
# 1.Need to steal the ctrl+g function from https://github.com/ohmyzsh/ohmyzsh/blob/master/plugins/jump/jump.plugin.zsh
# 2. Create symlinks instead of files
fastfile_dir="${HOME}/.cache/fastfile"
fastfile_var_prefix="#"
